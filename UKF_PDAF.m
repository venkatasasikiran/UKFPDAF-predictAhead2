function [FilterEstimateUKF,transWave,Measurements] = UKF_PDAF(ParPath,ParGen,Timings,Measurements,...
    ...
    for i = 1:n
        ...
        transWave(i,:) = Planner_Est(FilterEstimateUKF,ParPath,caseLoop,MVec,i);             
