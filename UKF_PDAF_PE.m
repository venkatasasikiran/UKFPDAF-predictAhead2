function [FilterEstimateUKF,transWave,Measurements] = UKF_PDAF_PE(ParPath,ParGen,Timings,Measurements,...
    ...
    for i = 1:n
        if i == 1
            ...
            transWave(i,:) = Planner_Est(FilterEstimateUKF,ParPath,"PE",MVec,i);
        end        
        ...
        if i < n
            ...
            if i == 1            
                transWave(i+1,:) = Planner_Est(FilterEstimateUKF,ParPath,"PE",MVec,i+1);
            end
        end
        ...
        if i < n-1
            ...
            transWave(i+2,:) = Planner_Est(FilterEstimateUKF2,ParPath,"PE",MVec,i+2);
        end       
